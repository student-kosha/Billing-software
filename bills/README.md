...
A desktop-based **Billing Management System** built using **Python, Tkinter, and MySQL**.
The application allows users to generate electronic product bills, calculate taxes automatically, store customer records, and search previously generated invoices through a simple graphical interface.
